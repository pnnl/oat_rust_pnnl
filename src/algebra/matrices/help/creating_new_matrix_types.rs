//! Want to create your own oracle?  Perfect!  That is what OAT's made for!
//! 
//! 
//! 
...
//! 
//! - A matrix is any struct that implements one of the [entry lookup traits](crate::algebra::matrices::matrix_oracle_traits).  In order to implement these traits, you will also need to implement [IndicesAndCoefficients](crate::algebra::matrices::query::IndicesAndCoefficients).
...
//!   - The crate for [scalar matrices](crate::algebra::matrices::types::scalar) module may be a good place to start, 
//! because the [`ScalarMatrix`](crate::algebra::matrices::types::scalar_algebra::matrices::ScalarMatrix) struct is one of the simplest oracles.
...
//! ```
//! // import crates
//! use oat_rust::algebra::matrices::query::{ ViewRow, IndicesAndCoefficients };          
//! 
//! 
//! //  -----------------------------------------------------------------------------------------
...
//! 
//! // Here we implement a trait with no methods; the trait doesn't do anything except specify five types: ColIndex, KeyMan, and Coefficient 
...
// //! //      src/oat/matrices/matrix_oracle_traits.rs, but it does not compile in doc string tests or
...
// //! use oat_rust::algebra::matrices::random_constructors::random_mod_p_upper_unitriangular;
