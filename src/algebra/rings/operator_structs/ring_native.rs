...
//! 
//! To define a semiring (or ring, or division ring) in OAT, you define an 
...
///
/// ```
/// use oat_rust::algebra::rings::operator_structs::ring_native::SemiringNative;
...
///
/// ```
/// use oat_rust::algebra::rings::operator_structs::ring_native::RingNative;
/// use oat_rust::algebra::rings::operator_traits::{Semiring, Ring};
///
...
pub type FieldFloat64 = DivisionRingNative < f64 >;

/// A ring operator for the field of rational numbers
/// 
/// Operates on elements of type `Ration<i64>`.
/// 
/// Note: ring operations are performed by floating point arithmetic and do not have infinite precision.
pub type FieldRational64 = DivisionRingNative < Ratio<i64> >;
...
/// 
/// Note: ring operations are performed by floating point arithmetic and do not have infinite precision.
pub type FieldRationalSize = DivisionRingNative < Ratio<isize> >;
...
pub fn foo() {
    let a = Ratio::new(1,1);
    let _b: Option< f64 > = a.to_f64();
}

// /// Convenience trait to convert an object to a float
// pub trait ToFloat { fn to_float( &self ) -> f64; }

// //  Implement for rationals
// //  -----------------------
// impl < T > ToFloat for Ratio< T >
//     where 
//         f64:    From< T >,
//         T:      Clone,
// {
...
//         { f64::from(self.numer().clone()) / f64::from(self.denom().clone()) }
// }
