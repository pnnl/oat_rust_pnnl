//! Iterators that represent sparse vectors.
//!
//! 
//! In oat_rust, any iterator that runs over [sparse vector entries](crate::entries) can be treated as a sparse vector.
//! 
...
// //! any struct that implements the [KeyValGet](crate::entries::KeyValGet) trait.
// //! 
// 
// //! 
// //!
...
// //! 
// //! ```
// //! let v = vec![ (1, 1.5), (2, 2.5) ]; // this is a standard Rust command; it's not special to oat_rust
// //! 
