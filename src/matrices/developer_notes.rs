...
//!   * Principle: use associated types for KeyMin, KeyMaj, SnzVal, and Ascending/Descending Major/Minor views.
//!     * Justification
...
//!               did not implement OracleMinor traits (only OracleMajor ones).  In the end, it seemed to us that we would have to create
