                ...
                RingOperator:     Semiring< RingElt > + Ring< RingElt >,
{
    ...
    for simplex in simplex_bimap.ord_to_val_vec() {
...
//     for simplex in simplex_bimap.ord_to_val_vec().iter().cloned() {
...
//             global_int_index    =   simplex_bimap.ord( & Simplex::from_vec( state_iter.facet.clone() ) ).unwrap();
//             vec.push( 
//                 (
...
use super::*;
use crate::{utilities::sequences_and_ordinals::SortedVec, topology::simplicial::simplices::vector::subsimplices_dim_0_thru_d_concatenated};

#[test]
fn test_bimap_to_boundary () {

let ring                    =   crate::algebra::rings::operator_structs::ring_native::DivisionRingNative::< f64 >::new();
