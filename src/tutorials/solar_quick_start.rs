...
//! # Quick start with oat_rust
//! 
//! Here's an example of how to write your own program using features from oat_rust.  
//!
//! **Step 1: Install Rust** 
//! 
...
//! 
//!    ```bash
//!    cargo new oat_rust_arithmetic
//!    ```
//!   This will make a new folder named `oat_rust_arithmetic,` which contains several Rust files.
...
//! 
//! 
//! **Step 3: Clone the oat_rust repository**  
//! 
...
//! 
//! **Step 4: Add oat_rust to your crate's dependencies.** 
//! 
...
//!   ```
//! 
//! **Step 5: Modify the file `main.rs` to use a feature from the oat_rust.** 
//! 
//! Let's use the oat_rust feature for arithmetic over finite fields.  Open
//! `oat_rust_arithmetic/src/main.rs`.  This should look like the following:
//! 
//!   ```
//!   fn main() {
//!       println!("Hello, world!");
...
//!   ```
//! 
//!   To use a feature from oat_rust, you'll add an "import" statement to the
...
//!   // Ring operators are tools that oat_rust uses to perform arithmetic over rings.
...
//! 
//! Make sure that the changes to `main.rs` are saved.  Open a terminal, and cd into the `oat_rust_arithmetic` directory.  Then run
//! ```bash
//! cargo run
//! ```
//! 
...
//! ```
//! 
//! Congratulations, you've just written and run a Rust program, with oat_rust!
//! 
...
// //! ## Add dependencies
// //! 
// //! This example shows how to use oat_rust in a new Rust crate.  There are two essential steps in this process: (1) modify
// //! the `Cargo.toml` folder by updating the section headed by `[dependencies]`, and (2) place `use` statements in your
// //! program file to indicate what features from oat_rust you want to use.
// //! 
...
// //! 
// //! 
// //! **Nota bene** there are two types of crates: library and binary.  The demo is a library crate.  The `oat_rust_arithmetic` crate that you just created is a binary crate.
// //! 
// //! 
// //! 
// //! 
