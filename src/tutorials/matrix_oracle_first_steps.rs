...
// //! `ViewRow` trait; it looks like a real mess.
// //! 
// //!
// //! ```ignore
// //! // Define the object
...
// //! use oat_rust::matrices::query::MajorDimension; 
// //! 
...
// //! to implement the `ViewRow` trait for our new struct.
// //! 
// //! ```
// //! // ORIGINAL CODE
// //! // impl < 'a, IndexCoeffPair > 
